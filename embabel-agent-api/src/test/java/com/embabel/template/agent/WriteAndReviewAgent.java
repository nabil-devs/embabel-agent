...
public class WriteAndReviewAgent {
    ...
    @Subflow
    record PolishStory(Story story) {

        @Action(goal = "Polish the story to improve its quality")
        Story polish(Ai ai) {
            return story;
        }
    ...
    @Action
    PolishStory craftStory(UserInput userInput, Ai ai) {
        var draft = ai
