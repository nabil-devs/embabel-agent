...
<13> **Goal Achievement**: `@AchievesGoal` marks this as a terminal action that completes the agent's objective. For simple cases, you can use `@Action(goal = "description")` as a shorthand.
